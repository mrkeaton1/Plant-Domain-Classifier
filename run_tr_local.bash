...
do
	...
	do
		...
		do
			...
			python3 train_resnet.py "/home/mrkeaton/Documents/Datasets/Annotated iNaturalist Dataset - edited (new)" fbnet_a $pt 64 64 10 $lr $mom
			python3 train_resnet.py "/home/mrkeaton/Documents/Datasets/Annotated iNaturalist Dataset - edited (new)" fbnet_c $pt 64 64 10 $lr $mom
		done
	done
done
