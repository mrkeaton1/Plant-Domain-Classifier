...
do
	for lr in 0.01 0.05 0.1 0.25 0.5 0.75
        do
			...
			#python3 train_test.py "/data/mrkeaton/Datasets/Annotated iNaturalist Dataset" efficientnet-b0 $pt 32 32 25 $lr $mom
			#python3 train_test.py "/data/mrkeaton/Datasets/Annotated iNaturalist Dataset" efficientnet-b7 $pt 4 4 25 $lr $mom
